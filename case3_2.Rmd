...
Bayesian linear regression method was slighlty better. For now, we will move 
...
research to see if any sort of prior distribution on the prescence of bed nets 
