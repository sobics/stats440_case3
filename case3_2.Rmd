...
For this stage of the project, we wanted to choose a method of imputation for our data. We tested 3 methods, 1 of which pertained to clustering and 2 of which were implemented through the "mice" package. For the methods implemented through the "mice" package, 100 iterations of 5 imputations were run in order for the estimates to converge. The estimated malaria indicator values were then compared to the real malaria indicator values to test for accuracy. 
