...
After 100 iterations, the model with the missing data imputated via price mean matching predicted the true test data set on average, `r round(mean(apply(TEST_ACCURACY, 2, mean)) * 100,2)`% of the time.
...
After 100 iterations, the model with the missing data imputated via price mean matching predicted the true test data set on average, `r round(mean(apply(TEST_ACCURACY2, 2, mean)),2) * 100`% of the time.
