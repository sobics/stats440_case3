...
```{r echo = F}
ggplot(gambia[-i,], aes(x=factor(PHC), y = factor(GREEN), color = factor(GREEN), size = 5)) + geom_point() + ggtitle("PHC vs. GREEN") + theme(legend.position="none") + xlab("PHC") + ylab("GREEN") 
```
